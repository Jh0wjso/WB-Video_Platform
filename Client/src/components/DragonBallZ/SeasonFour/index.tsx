    ...
    <div className="containerEps">
      ...
      <section className="mt-8 flex flex-col items-center">
        ...
        <section className="episodeButtons">
          <SectionLinks num="114" name="dragon-ball-z-dublado" />
          <SectionLinks num="115" name="dragon-ball-z-dublado" />
          <SectionLinks num="116" name="dragon-ball-z-dublado" />
          <SectionLinks num="117" name="dragon-ball-z-dublado" />
        </section>
      </section>
    </div>
  );

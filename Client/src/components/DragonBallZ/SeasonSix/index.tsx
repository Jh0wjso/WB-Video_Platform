...
export default function SeasonSixDbz(){
    ...
    <div className="containerEps">
        ...
        <section className=" flex flex-col items-center">
            ...
            num4="143" name4="dragon-ball-z-dublado"
            num5="144" name5="dragon-ball-z-dublado"
            ...
            num4="149" name4="dragon-ball-z-dublado"
            num5="150" name5="dragon-ball-z-dublado"
            ...
            num4="155" name4="dragon-ball-z-dublado"
            num5="156" name5="dragon-ball-z-dublado"
            ...
            num4="161" name4="dragon-ball-z-dublado"
            num5="162" name5="dragon-ball-z-dublado"
            ...
            num4="167" name4="dragon-ball-z-dublado"
            num5="168" name5="dragon-ball-z-dublado"
            ...
            num4="173" name4="dragon-ball-z-dublado"
            num5="174" name5="dragon-ball-z-dublado"
            ...
            num4="179" name4="dragon-ball-z-dublado"
            num5="180" name5="dragon-ball-z-dublado"
            ...
            num4="185" name4="dragon-ball-z-dublado"
            num5="186" name5="dragon-ball-z-dublado"
            ...
            num4="191" name4="dragon-ball-z-dublado"
            num5="192" name5="dragon-ball-z-dublado"
            ...
            num4="197" name4="dragon-ball-z-dublado"
            num5="198" name5="dragon-ball-z-dublado"
            num6="199" name6="dragon-ball-z-dublado"
            />
        </section>
    </div>
  );

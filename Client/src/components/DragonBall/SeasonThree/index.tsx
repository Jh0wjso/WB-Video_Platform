    ...
    <div className="containerEps">
      ...
      <section className="mt-8 flex flex-col items-center">
        <SectionButtons 
          ...
          num4="32" name4={`dragon-ball-dublado`}
          num5="33" name5={`dragon-ball-dublado`}
        ...
        <SectionButtons 
          ...
          num4="38" name4={`dragon-ball-dublado`}
          num5="39" name5={`dragon-ball-dublado`}
        ...
        <SectionButtons 
          ...
          num4="44" name4={`dragon-ball-dublado`}
          num5="45" name5={`dragon-ball-dublado`}
        ...
        <SectionButtons 
          ...
          num4="50" name4={`dragon-ball-dublado`}
          num5="51" name5={`dragon-ball-dublado`}
        ...
        <SectionButtons 
          ...
          num4="56" name4={`dragon-ball-dublado`}
          num5="57" name5={`dragon-ball-dublado`}
        ...
        <SectionButtons 
          ...
          num4="62" name4={`dragon-ball-dublado`}
          num5="63" name5={`dragon-ball-dublado`}
        ...
        <SectionButtons 
          ...
          num4="68" name4={`dragon-ball-dublado`}
          num5="69" name5={`dragon-ball-dublado`}
        ...
        <SectionButtons 
          ...
          num4="74" name4={`dragon-ball-dublado`}
          num5="75" name5={`dragon-ball-dublado`}
          num6="76" name6={`dragon-ball-dublado`}
        />
